...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PREPAREREQUEST']._serialized_end=225
  _globals['_DATABASESERVICE']._serialized_start=228
  _globals['_DATABASESERVICE']._serialized_end=422
